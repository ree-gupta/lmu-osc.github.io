  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Explore existing resources, write data management plans, design studies, and prepare preregistrations.</p>
      </div>
...
<div class="modal fade" id="modalPhase2" tabindex="-1" aria-labelledby="modalPhase2Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Implement FAIR data management, use standard protocols, ensure storage & backup, and perform quality control.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<div class="modal fade" id="modalPhase3" tabindex="-1" aria-labelledby="modalPhase3Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Create reproducible analyses, use version control, document code, and establish collaboration workflows.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
<div class="modal fade" id="modalPhase4" tabindex="-1" aria-labelledby="modalPhase4Label" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Publish data, archive code, ensure open access articles, and obtain DOIs for citations.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
